...
public class IHouseInsuranceAlliance implements HouseInsuranceBuilder {
    ...
    public IHouseInsuranceAlliance() {

        this.houseInsurance = new HouseInsurance();
        this.houseInsurance.setFactoryType(FactoryType.Alliance);
    }
