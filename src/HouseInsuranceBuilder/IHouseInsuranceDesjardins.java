...
public class IHouseInsuranceDesjardins implements HouseInsuranceBuilder {
    ...
    public IHouseInsuranceDesjardins() {

        this.houseInsurance = new HouseInsurance();
        this.houseInsurance.setFactoryType(FactoryType.Desjardins);
    }
