...
public class ICarInsuranceDesjardins implements CarInsuranceBuilder {
    ...
    public ICarInsuranceDesjardins() {

        this.carInsurance = new CarInsurance();
        this.carInsurance.setFactoryType(FactoryType.Desjardins);
    }
