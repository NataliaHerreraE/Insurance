...
public class ILifeInsuranceDesjardins implements LifeInsuranceBuilder {
    ...
    public ILifeInsuranceDesjardins() {

        this.lifeInsurance = new LifeInsurance();
        this.lifeInsurance.setFactoryType(FactoryType.Desjardins);
    }
