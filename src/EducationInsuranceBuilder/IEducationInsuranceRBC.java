...
public class IEducationInsuranceRBC implements EducationInsuranceBuilder {
    ...
    public IEducationInsuranceRBC() {

        this.educationInsurance = new EducationInsurance();
        this.educationInsurance.setFactoryType(FactoryType.RBC);
    }
