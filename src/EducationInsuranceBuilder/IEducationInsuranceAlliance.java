...
public class IEducationInsuranceAlliance implements EducationInsuranceBuilder {
...
//    }
    public IEducationInsuranceAlliance() {

        this.educationInsurance = new EducationInsurance();
        this.educationInsurance.setFactoryType(FactoryType.Alliance);
    }
