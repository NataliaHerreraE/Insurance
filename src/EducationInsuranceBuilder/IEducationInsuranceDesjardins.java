...
public class IEducationInsuranceDesjardins implements EducationInsuranceBuilder {
...
//    public ICarInsuranceDesjardins(String clientName, double yearlyFee, int risk, double insuranceAmount) {
...
//    }
    public IEducationInsuranceDesjardins() {

        this.educationInsurance = new EducationInsurance();
        this.educationInsurance.setFactoryType(FactoryType.Desjardins);
    }
